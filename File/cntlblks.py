...
class DEntry(ControlBlock):
    ...
    def rmFile(self, fcb):
        ...
        file_idx = self.content.index(fcb)
        self.content.pop(file_idx)
        self.names.pop(file_idx)
        fcb.decrLinkCount()
        self.updateModTime()
    ...
    def rmDir(self, d):
        ...
        d_idx = self.content.index(d)
        self.content.pop(d_idx)
        self.names.pop(d_idx)
        d.parent = None
        self.updateModTime()
